...
\Cref{tab:api} lists the public API as of v0.2.0.

\begin{table}[H]
\centering
\caption{vol-eval public API as of v0.2.0.}
\label{tab:api}
\footnotesize
...
The package ships with 45 unit tests. The tests fall into five categories:
