...
Beyond the self-contained seven-model demonstration, this paper applies \texttt{vol-eval} to a sample of 30 published volatility-forecasting comparison papers from 2018--2025, drawn from the \emph{Journal of Financial Econometrics}, three open-access MDPI venues (\emph{Mathematics}, \emph{Risks}, \emph{Journal of Risk and Financial Management}), and arXiv q-fin. Three layered findings emerge from this Phase 2 analysis (developed in detail in \Cref{sec:phase2}):
